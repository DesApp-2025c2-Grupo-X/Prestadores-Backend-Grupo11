...
const crearAutorizaciones = async () => {
    await Autorizacion.bulkCreate([
        ...
        },
        {
            ...
            lugar: 'Clínica Santa María',
            dias_internacion: 2,
            observaciones: 'Evaluación por dolor torácico recurrente',
            estado: 'en analisis',
            motivo: null,
            fecha_finalizacion: null,
            usuarioUltimoCambio: 2
        ...
        {
            fecha_prevista: new Date('2025-12-10'),
            integranteId: 7,
            medico: 'dr cecilia lopez',
            especialidad: 'Clínica',
            lugar: 'Hospital Central',
            dias_internacion: 1,
            observaciones: 'Sospecha de infección respiratoria',
            estado: 'recibido',
            motivo: null,
            fecha_finalizacion: null,
        ...
        {
            fecha_prevista: new Date('2025-12-15'),
            integranteId: 29,
            medico: 'dr alejandro ruiz',
            especialidad: 'Cardiología',
            lugar: 'Clínica Santa María',
        ...
        {
            fecha_prevista: new Date('2025-12-05'),
            integranteId: 3,
            medico: 'dr cecilia lopez',
            especialidad: 'Clínica',
            lugar: 'Hospital Central',
            dias_internacion: 3,
            observaciones: 'Cuadro febril persistente',
            estado: 'rechazado',
        ...
        },
        {
            ...
            dias_internacion: 1,
            observaciones: 'Evaluación de hipertensión no controlada',
            estado: 'observado',
        ...
        {
            fecha_prevista: new Date('2025-12-11'),
            integranteId: 9,
            medico: 'dr alejandro ruiz',
            especialidad: 'Cardiología',
            lugar: 'Clínica Santa María',
            dias_internacion: 1,
            observaciones: 'Taquicardia paroxística en estudio',
            estado: 'recibido',
            motivo: null,
            fecha_finalizacion: null,
            usuarioUltimoCambio: null
        ...
        {
            fecha_prevista: new Date('2025-12-17'),
            integranteId: 32,
            medico: 'dr cecilia lopez',
            especialidad: 'Clínica',
            lugar: 'Hospital Central',
            dias_internacion: 1,
            observaciones: 'Deshidratación moderada por cuadro gastrointestinal',
            estado: 'observado',
        ...
        },
        {
            ...
            lugar: 'Clínica Metropolitana',
            dias_internacion: 2,
            observaciones: 'Sospecha de insuficiencia cardíaca incipiente',
            estado: 'rechazado',
            motivo: 'No se adjuntó ecocardiograma reciente',
            fecha_finalizacion: new Date(),
            usuarioUltimoCambio: 1
        },
        {
            fecha_prevista: new Date('2025-12-04'),
            integranteId: 25,
            medico: 'dr cecilia lopez',
            especialidad: 'Clínica',
            lugar: 'Hospital Central',
